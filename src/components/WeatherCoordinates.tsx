    ...
    <View testID="weather-coordinates">
      <View style={styles.inputs}>
        ...
        {form.errors.latitude && (
          <Text style={styles.error}>Latitude deve ser um número valido</Text>
        )}
        <Controller
          control={form.control}
          render={({onChange, ...p}) => (
        ...
        {form.errors.longitude && (
          <Text style={styles.error}>Longitude deve ser um número valido</Text>
        )}
      </View>
      <Button onPress={handleSubmit} label="Procurar" />
    </View>
  );
}
