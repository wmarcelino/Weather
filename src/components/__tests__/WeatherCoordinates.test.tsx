...
describe('WeatherCoordinates', () => {
  ...
  describe('Latitude field', () => {
    test('Should not show error when value is the lowest range value', () => {
      ...
      return expect(
        wrapper.findByText('Latitude deve ser um número valido'),
      ).rejects.toThrow();
    });
    ...
    test('Should show error when value is lower than the lowest range value', async () => {
      ...
      await waitFor(() => {
        wrapper.getByText('Latitude deve ser um número valido');
      });
    });
  ...
  describe('Longitude field', () => {
    test('Should not show error when value is the lowest range value', () => {
      ...
      return expect(
        wrapper.findByText('Longitude deve ser um número valido'),
      ).rejects.toThrow();
    });
    ...
    test('Should show error when value is lower than the lowest range value', async () => {
      ...
      await waitFor(() => {
        wrapper.getByText('Longitude deve ser um número valido');
      });
    });
