...
describe('WeatherScreen', () => {
  ...
  test('Should display formated temperature', () => {
    ...
    const title = wrapper.getByText('Temperatura');
  ...
  test('Should display formated wind', () => {
    ...
    const title = wrapper.getByText('Vento');
  ...
  test('Should display formated humidity', () => {
    ...
    const title = wrapper.getByText('Umidade');
  ...
  test('Should display formated pressure', () => {
    ...
    const title = wrapper.getByText('Pressão');
